    ...
    <>
      <div className="fixed bottom-8 right-8 z-50">
        <button 
          ...
          className="px-6 py-4 bg-gold text-background text-xs uppercase tracking-[0.2em] font-bold hover:bg-gold-light shadow-[0_0_20px_rgba(197,160,89,0.3)] hover:shadow-[0_0_30px_rgba(197,160,89,0.5)] transition-all duration-300"
        >
          Acceso Exclusivo
        </button>
      </div>
        ...
        {isOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-lg bg-gray-dark border border-gold/20 p-8 shadow-2xl"
            >
              <button 
                onClick={() => setIsOpen(false)}
              ...
              <div className="mb-8 text-center mt-4">
                <h3 className="text-2xl font-serif text-gold-light mb-2">Club Privado Summum</h3>
                <p className="text-foreground/70 text-sm font-light">Regístrate para obtener tu código único de cliente y acceder a atención personalizada.</p>
              </div>
              ...
              {!generatedCode ? (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button type="submit" className="w-full py-4 mt-6 bg-gold text-background font-medium tracking-[0.2em] uppercase hover:bg-gold-light transition-colors text-sm">
                    Generar Mi Código
                  </button>
                </form>
              ) : (
